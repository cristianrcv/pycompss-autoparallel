...
@task(lbp=IN, ubp=IN, coef1=IN, coef2=IN, returns="LT3_args_size")
def LT3(lbp, ubp, coef1, coef2, *args):
...
def fdtd_1d(e, h, n_size, t_size, coef1, coef2):
    ...
    if n_size >= 2 and t_size >= 1:
        ...
        for t1 in range(1, n_size + 2 * t_size - 3 + 1):
            ...
            LT3_aux_0 = [h[-t1 + 2 * t2] for t2 in range(lbp, ubp + 1)]
            LT3_aux_1 = [e[-t1 + 2 * t2 - 1] for t2 in range(lbp, ubp + 1)]
