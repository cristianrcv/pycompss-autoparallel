#!/bin/bash -e
  ...
  MSIZES=(    16       16   16   16     6    8    32     6    8    32)      # 32   32)
  BSIZES=(    2048     512  1024 4096   2048 2048 2048   4096 4096 4096)    # 2048 2048)
  NUM_NODES=( 2        2    2    2      2    2    2      2    2    2)       # 3    5)
  EXEC_TIMES=(20       5    10   120    10   10   250    40   40   480)     # 50   30)
